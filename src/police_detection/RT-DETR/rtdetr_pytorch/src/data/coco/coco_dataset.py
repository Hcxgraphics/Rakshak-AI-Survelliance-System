...
from torchvision.transforms.v2 import ConvertImageDtype as TVConvertDtype
from src.core import register

@register
class ConvertDtype(TVConvertDtype):
    pass


# Dummy fallback classes (simulate datapoints)
...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        if "boxes" not in target or len(target["boxes"]) == 0:
            ...
            for _ in range(10):
                ...
                raise RuntimeError("Too many empty or corrupted samples in dataset.")
    ...
    def __len__(self):
        return len(self.ids)  # or equivalent
